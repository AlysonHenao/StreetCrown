    ...
    <div class="col-12 col-md-8 col-lg-5">
        ...
        <div class="auth-card">
            <div class="auth-card__icon-wrapper mb-4">
                ...
                <h2 class="auth-card__title">{{ __('auth.login_title') }}</h2>
                <p class="auth-card__subtitle">{{ __('auth.login_subtitle') }}</p>
            </div>
            ...
            <form method="POST" action="{{ route('login') }}" novalidate>
                ...
                <div class="auth-form__remember mb-4">
                    <div class="form-check">
                        <input
                            class="form-check-input auth-form__checkbox"
                            type="checkbox"
                            id="remember"
                            name="remember"
                            {{ old('remember') ? 'checked' : '' }}
                        />
                        <label class="form-check-label auth-form__check-label" for="remember">
                            {{ __('auth.remember_me') }}
                        </label>
                    </div>
                </div>
            ...
            <a href="{{ route('register') }}" class="auth-btn auth-btn--outline w-100 mt-3 d-flex justify-content-center">
